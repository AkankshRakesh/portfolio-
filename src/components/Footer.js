    ...
    font-medium text-lg sm:text-base'>
      ...
      md:py-6 xs:py-6 sm:py-6'>
            ...
            <div className='lg:py-2 md:py-2 sm:py-2 xs:py-2'>
                <Link href = "https://www.linkedin.com/in/akankshrakesh/" target="_blank">Built by <span className='underline'>Akanksh Rakesh</span></Link>
            </div>
            <Link href = "https://www.linkedin.com/in/akankshrakesh/" target="_blank" className='underline'>Say hello</Link>
      </Layout>
    </footer>
  )
}
